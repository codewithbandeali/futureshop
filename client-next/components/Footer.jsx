            ...
            <div className="max-w-7xl mx-auto px-6 py-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <nav aria-label="Shop">
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li><Link href="/shop" className="hover:text-[color:var(--color-accent)] transition">New arrivals</Link></li>
                        <li><Link href="/shop" className="hover:text-[color:var(--color-accent)] transition">Best sellers</Link></li>
                    </ul>
                </nav>
                <nav aria-label="Help">
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li><Link href="/" className="hover:text-[color:var(--color-accent)] transition">Returns &amp; refunds</Link></li>
                        <li><Link href="/" className="hover:text-[color:var(--color-accent)] transition">Contact us</Link></li>
                    </ul>
                </nav>
                <nav aria-label="Company">
                    <p className="text-sm uppercase tracking-[0.1em] text-white/60 mb-3">Company</p>
                    <ul className="space-y-2 text-sm">
                        <li><Link href="/" className="hover:text-[color:var(--color-accent)] transition">About</Link></li>
                        <li><Link href="/" className="hover:text-[color:var(--color-accent)] transition">Privacy</Link></li>
                        <li><Link href="/" className="hover:text-[color:var(--color-accent)] transition">Terms</Link></li>
                    </ul>
                </nav>
            </div>
